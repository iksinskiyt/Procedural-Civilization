...
public abstract class Building {
    ...
    private static final EnumMap<BuildingType, EnumMap<Inventory.ItemType, Integer>> materialCosts =
    ...
    private static final HashMap<Village, EnumMap<BuildingType, Integer>> buildingsCreatedFor = new HashMap<>();
    ...
    public static Building createNew(BuildingType buildingType,
        ...
        EnumMap<BuildingType, Integer> numberOfBuildings = buildingsCreatedFor.get(parentVillage);
        if(numberOfBuildings == null)
            numberOfBuildings = new EnumMap<>(BuildingType.class);
        numberOfBuildings.put(buildingType, getNumberOfBuildingsFor(parentVillage, buildingType) + 1);
    ...
    public static int getNumberOfBuildingsFor(Village village, BuildingType buildingType)
    {
        EnumMap<BuildingType, Integer> numberOfBuildings = buildingsCreatedFor.get(village);
        if(numberOfBuildings == null)
            return 0;
        else
    ...
    public static EnumMap<Inventory.ItemType, Integer> getMaterialCosts(BuildingType buildingType)
    {
